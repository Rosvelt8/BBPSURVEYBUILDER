			...
			<div class="table-data">
                    ...
                    <form class="form-create-survey" action="" method="post" enctype="multipart/form-data">
                        <div class="form-input">
                            ...
                            <?php if($_SESSION['status']=='I'){?>
                                ...
                                <img src="../assets/img/enqueteur.png" height="300" width="auto" id="file-ip-1-preview" alt="" ><br>
                                <?php }?>
                                <?php if($_SESSION['status']=='A'){?>
                                    <img src="../assets/img/admin.png" height="300" width="auto" id="file-ip-1-preview" alt="" ><br>
                        ...
                        <div class="form-title">
                            <label for="">nom</label>
                            <input name="title" value="<?=$getInformation['name']?>" id="title" type="text" disabled>
                        </div>
                        <div class="form-title">
                            <label for="">pays</label>
                            <input name="title" value="<?=$getInformation['country']?>" id="title" type="text" disabled>
                        </div>
                        <div class="form-title">
                            <label for="">telephone</label>
                            <input name="title" value="<?=$getInformation['phone']?>" id="title" type="text" disabled>
                        </div>
				...
				<div class="todo" style="overflow-x: hidden;">
					...
					<ul class="todo-list" id="list-question">
                        ...
                        <li class="completed" id="to-add">
                        <form action="" method="POST" style="width: 100%">
							<input placeholder="" value="<?=$getInformation['password']?>" name="intitle" type="password" style="background-color: transparent; outline: none; border: none; border-bottom: 1px solid var(--blue); width: 82%; padding: 0;">
							<button class="addQ" type="submit" name="addQuestion"><i class='bx bx-edit' ></i></button>
                        </form>
						</li>
                        <style>
                            .addQ{
                    ...
                    <?php if($_SESSION['status']=='I'){?>
                        ...
                        <ul class="todo-list" id="list-question">
                            <li class="completed">
                                <p>Debut :<?=$getSubscription['begindate']?> Fin: <?=$getSubscription['enddate']?></p>
                            </li>
                            <li class="completed">
                                <p>Type :<?=$getSubscription['label']?> </p>
                            </li>
